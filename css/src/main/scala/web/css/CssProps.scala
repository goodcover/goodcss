...
trait CssProps {
  ...
  val borderBottomWidth        = prop"border-bottom-width"
  ...
  val outlineOffset            = prop"outline-offset"
  ...
  val textDecorationColor      = prop"text-decoration-color"
  val textDecorationLine       = prop"text-decoration-line"
  val textDecorationThickness  = prop"text-decoration-thickness"
  val textDecorationStyle      = prop"text-decoration-style"
